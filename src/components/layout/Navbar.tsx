...
import {
  ...
  ArrowRight,
  ShieldCheck,
  BookOpen, // Added for a visual hint in mobile menu
} from 'lucide-react'
import { FaInstagram, FaWhatsapp } from 'react-icons/fa'
import { NAV_LINKS } from '@/src/constants'
import { cn } from '@/src/lib/utils'
      ...
      <header className='fixed top-6 inset-x-0 z-[100] flex justify-center px-4'>
        ...
        >
          ...
          <div className='hidden lg:flex items-center bg-white/5 rounded-full px-2 py-1 border border-white/5'>
            ...
            {/* Added Journal Link for Desktop */}
            <Link 
              href="/blog"
              className='relative px-5 py-2 text-sm font-bold text-slate-300 hover:text-[#D97706] transition-colors group'
            >
                  ...
                  <div className='flex flex-col gap-1'>
                    ...
                    >
                      <Link
                        href="/blog"
                        onClick={() => setIsOpen(false)}
                        className='py-2.5 text-xl font-bold text-[#D97706] hover:brightness-125 transition-all flex items-center justify-between group'
                      >
                        <span className='group-hover:translate-x-1 transition-transform'>
                          Journal
                        </span>
                        <BookOpen size={18} className='opacity-40 group-hover:opacity-100' />
                      </Link>
                    </motion.div>
                  </div>
                </div>
